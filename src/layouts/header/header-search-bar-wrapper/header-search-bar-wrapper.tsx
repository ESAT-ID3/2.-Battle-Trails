...
const HeaderSearchBarWrapper = ({ setSearchOpen ,currentPath}: { setSearchOpen: (value: boolean) => void; currentPath:string }) => {
    ...
    return (
        <div className={`absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md flex justify-center ${headerClass}`}>
